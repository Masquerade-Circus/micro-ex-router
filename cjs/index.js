...
var index$6 = createCommonjsModule(function (module) {
    ...
    iconv.getCodec = function getCodec(encoding) {
        if (!iconv.encodings) iconv.encodings = index$8; // Lazy load all encoding definitions.
...
function getDecoder(encoding) {
  ...
  try {
    return index$6.getDecoder(encoding);
  } catch (e) {
...
function getRawBody(stream, options, callback) {
  ...
  var limit = index$4.parse(opts.limit);
...
function readStream(stream, encoding, length, limit, callback) {
  ...
  function onData(chunk) {
    ...
    decoder ? buffer$$1 += decoder.write(chunk) : buffer$$1.push(chunk);
...
var parse$3 = function parse(str, opts) {
    var options = opts ? utils.assign({}, opts) : {};
...
var parse = index$14.parse;


var dist = function parseFormData(req) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      _ref$limit = _ref.limit,
      limit = _ref$limit === undefined ? '1mb' : _ref$limit;

  return __async(regeneratorRuntime.mark(function _callee() {
    var type, encoding, str, data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            type = req.headers['content-type'];
            encoding = type ? index$12.parse(type).parameters.charset : 'UTF-8';


            req.rawBody = req.rawBody || index$2(req, { limit: limit, encoding: encoding });
            _context.next = 5;
            return req.rawBody;
